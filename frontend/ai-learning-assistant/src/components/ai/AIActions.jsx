...
const AIActions = () => {
  ...
  return (
    ...
    <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden'>
        {/* Header */}
        <div className='px-6 py-5 border-slate-200/50 bg-linear-to-br from-slate-50/50 to-white/50'>
            <div className='flex items-center gap-3'>
                <div className='w-10 h-10 rounded-xl bg-linear-to-br from-emerald-500 to-emerald-600 sadow-purple-500/25 flex items-center justify-center'>
        ...
        <div className='p-6 space-y-6'>
            ...
            <div className='flex items-start justify-between gap-4'>
                <div className='flex-1'>
                    <div className='flex items-center gap-2 mb-2'>
                        <div className='w-8 rounded-lg bg-linear-to-br from-blue-100 to-cyan-100 flex items-center justify-center'>
                            <BookOpen
           ...
           {/* Explain concept */}
           <div className='group p-5 bg-linear-to-br from-slate-50/50 to-white rounded-xl  border-slate-200/50 hover:border-slate-300/60 hover:shadow-md transition-all duration-200'>
              <form onSubmit={handleExplainConcept}>
                <div className='flex items-center gap-2 mb-3'>
                    <div className='w-8 h-8 rounded-lg bg-linear-to-br from-amber-100 flex items-center justify-center'>
                        <Lightbulb
                ...
                <div className='flex items-center gap-3'>
                    <input
                      ...
                      className='shrink-0 h-11 px-5 bg-linear-to-r from-emerald-600 to-emerald-500 hover:from-emerald-600'
                      >
           ...
           {/* Result Modal */}  Jo summary wala box open ho kr aata hai..wo yhi se aa rha hai
           <Modal
             isOpen={isModalOpen}
